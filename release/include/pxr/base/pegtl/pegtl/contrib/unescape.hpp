...
#ifndef PXR_PEGTL_CONTRIB_UNESCAPE_HPP
#define PXR_PEGTL_CONTRIB_UNESCAPE_HPP
...
namespace PXR_PEGTL_NAMESPACE::unescape
{
   ...
   // This function MUST only be called for characters matching PXR_PEGTL_NAMESPACE::ascii::xdigit!
   template< typename I >
   ...
   // This action MUST be called for a character matching T which MUST be PXR_PEGTL_NAMESPACE::one< ... >.
