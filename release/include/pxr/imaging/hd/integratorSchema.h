...
#ifndef PXR_IMAGING_HD_INTEGRATOR_SCHEMA_H
#define PXR_IMAGING_HD_INTEGRATOR_SCHEMA_H
...
public:
    ...
    /// "integrator" from the parent container and constructs a
    /// HdIntegratorSchema instance.
    /// Because the requested container data source may not exist, the result
    /// should be checked with IsDefined() or a bool comparison before use.
    HD_API
    static HdIntegratorSchema GetFromParent(
