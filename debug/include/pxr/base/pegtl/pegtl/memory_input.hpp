...
#ifndef PXR_PEGTL_MEMORY_INPUT_HPP
#define PXR_PEGTL_MEMORY_INPUT_HPP
...
namespace PXR_PEGTL_NAMESPACE
{
   namespace internal
   {
      ...
      public:
         ...
         [[nodiscard]] PXR_PEGTL_NAMESPACE::position position( const iterator_t& it ) const
         {
            return PXR_PEGTL_NAMESPACE::position( it, m_source );
         }
      ...
      public:
         ...
         [[nodiscard]] PXR_PEGTL_NAMESPACE::position position( const iterator_t it ) const
         {
            ...
            return PXR_PEGTL_NAMESPACE::position( c, m_source );
         }
   ...
   public:
      ...
      [[nodiscard]] const char* at( const PXR_PEGTL_NAMESPACE::position& p ) const noexcept
      {
         return this->begin() + p.byte;
      }

      [[nodiscard]] const char* begin_of_line( const PXR_PEGTL_NAMESPACE::position& p ) const noexcept
      {
         return at( p ) - ( p.column - 1 );
      }

      [[nodiscard]] const char* end_of_line( const PXR_PEGTL_NAMESPACE::position& p ) const noexcept
      {
      ...
      [[nodiscard]] std::string_view line_at( const PXR_PEGTL_NAMESPACE::position& p ) const noexcept
      {
