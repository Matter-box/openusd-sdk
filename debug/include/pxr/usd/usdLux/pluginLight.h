...
//
#ifndef USDLUX_GENERATED_PLUGINLIGHT_H
#define USDLUX_GENERATED_PLUGINLIGHT_H
...
public:
    ...
    /// Return a UsdLuxPluginLight holding the prim adhering to this
