...
//
#ifndef PXR_USD_IMAGING_USD_IMAGING_RENDER_VAR_ADAPTER_H
#define PXR_USD_IMAGING_USD_IMAGING_RENDER_VAR_ADAPTER_H

/// \file usdImaging/renderVarAdapter.h
...
/// \class UsdImagingRenderVarAdapter
///
/// Adapter support for UsdRenderVar for *only* the scene index (2.0) API.
///
...
///       products and vars. 
///
class UsdImagingRenderVarAdapter : public UsdImagingPrimAdapter {
public:
    ...
    USDIMAGING_API
    ~UsdImagingRenderVarAdapter() override;
...
#endif // PXR_USD_IMAGING_USD_IMAGING_RENDER_VAR_ADAPTER_H
