...
if(ON)
    if (NOT DEFINED Python3_EXECUTABLE)
        if (NOT [[C:\dev\python\3.10.6\python.exe]] STREQUAL "")
            set(Python3_EXECUTABLE [[C:\dev\python\3.10.6\python.exe]])
        endif()
    endif()

    if (NOT DEFINED Python3_LIBRARY)
        if (NOT [[C:\dev\python\3.10.6\libs\python310_d.lib]] STREQUAL "")
            set(Python3_LIBRARY [[C:\dev\python\3.10.6\libs\python310_d.lib]])
        endif()
    endif()

    if (NOT DEFINED Python3_INCLUDE_DIR)
        if (NOT [[C:\dev\python\3.10.6\Include]] STREQUAL "")
            set(Python3_INCLUDE_DIR [[C:\dev\python\3.10.6\Include]])
        endif()
    endif()

    if (NOT DEFINED Python3_VERSION)
        find_dependency(Python3 "3.10.6" EXACT COMPONENTS Development)
    else()
...
if(ON)
    if (NOT DEFINED MaterialX_DIR)
        if (NOT [[C:/dev/USD/Debug/v25.05.01/lib/cmake/MaterialX]] STREQUAL "")
            set(MaterialX_DIR [[C:/dev/USD/Debug/v25.05.01/lib/cmake/MaterialX]])
        endif()
    endif()
...
if(1)
    if (NOT DEFINED Imath_DIR)
        if (NOT [[C:/dev/USD/Debug/v25.05.01/lib/cmake/Imath]] STREQUAL "")
            set(Imath_DIR [[C:/dev/USD/Debug/v25.05.01/lib/cmake/Imath]])
        endif()
    endif()
